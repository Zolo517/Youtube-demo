export function Navbar() {
  return (
    <div className="w-100vw h-[56px] px-[22px] flex justify-between items-center">
      <div className=" w-[141px] flex justify-between">
        <svg
      ...
      <div className="flex gap-5">
        <div
          className="ml-[50px] flex rounded-3xl w-[590px] h-10 justify-between items-center overflow-hidden"
          style={{ border: "1px solid #282828" }}
        >
          <div>
          <input type="text" placeholder="Search" className="  w-[526px] h-10 px-4"/>
          </div>
          <div className="flex items-center justify-center w-16 h-10" style={{ backgroundColor: "#282828" }}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              height="24"
        ...
        <div className="rounded-3xl w-10 h-10 flex items-center justify-center" style={{ backgroundColor: "#282828" }}><svg
          xmlns="http://www.w3.org/2000/svg"
          height="24"
          fill="currentColor"
          viewBox="0 0 24 24"
      ...
      <div className="w-[210px] h-[40px] flex justify-between items-center">
        <div
          className="w-[100px] h-[36px] bg-inherit  rounded-3xl flex justify-between items-center p-[20px]"
        ...
        <div className="w-[32px] h-[32px] flex justify-center items-center rounded-3xl mr-3" style={{backgroundColor: "#684E47"}}>
